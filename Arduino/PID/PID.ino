...
LiquidCrystal_I2C lcd(0x30,16,4);  //sometimes the adress is not 0x3f. Change to 0x27 if it dosn't work.
...
int PID_p = 1;    int PID_i = 0;    int PID_d = 0;
...
void setup() {
  ...
  lcd.init();
  lcd.backlight();
  Serial.begin(9600); // Inicializar puerto serial a 9600 bps
}
